...
export function SchedulingClient({ schedules, employees }: SchedulingClientProps) {
  ...
  const totalShifts = schedules.reduce((acc, s) => acc + s.shifts.length, 0);
  const scheduledEmployees = schedules.filter((s) => s.shifts.length > 0).length;
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 animate-fade-in-up">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => toast.info("Add shift feature coming soon!")} className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white shadow-md rounded-xl">
